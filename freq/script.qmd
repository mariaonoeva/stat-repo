...
Disclaimer :point_up:: All of this with one-way ANOVA is done only for an explanatory and study purpose. My design is within-subject, so technically I cannot use one-way ANOVA. I violate so many things here :grimacing:

Disclaimer :v:: All taken from [this web](https://statsandr.com/blog/anova-in-r/), [this web](https://support.minitab.com/en-us/minitab/help-and-how-to/statistical-modeling/anova/supporting-topics/basics/what-is-anova/) and Levshina (2016).
...
```
Below is the most common output from ANOVA. Once again I violate perhaps all conditions that can be violated but who cares. 
