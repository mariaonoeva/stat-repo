...
modelsummary(e1_df.lm, output = "gt", 
...
GM_e1 <- mean(as.numeric(e1_df$rating1))
```
...
V1_mean <- e1_df %>% 
  filter(verb=='V1 li') %>%
  summarise(mean_rating = mean(as.numeric(rating1), na.rm = TRUE))
...
c(contrasts(e1_df$verb), contrasts(e1_df$context), contrasts(e1_df$indef))
