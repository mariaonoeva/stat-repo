...
The goal of the experiment was to find out how natural are various negated polar questions in different context. There were three independent variables, each had two manipulations, so the design was 2 x 2 x 2. There variables were:
...
The purpose of inferential stat here is to check if the experimental results were not produced by chance.
